...
以下のJSON形式で出力してください（他のテキスト不要）：
{
  ...
  "reelNarration": "（15秒リール用ナレーション。ルール：車名から始めない。記事の中で最もインパクトのある一節から入る。「実は…」「一切の…」「残ったのは…」のような、聴いた人が「ん？何の話？」と止まるフックから始める。記事全文の中から最も印象的な一節を抜き出して再構成する。【構成】前半で車の魅力を2〜3フレーズで語り、後半でブランドメッセージへ自然につなげる。【締めくくり】最後にブランドメッセージを入れる。必ず「ハイトップコーポレーション」のフルネームと「マイ パッション イズ ワン コード」を含めること。車や記事に合わせて毎回表現を変える。全体で100〜130文字（読み上げ約13〜15秒）。ElevenLabs v3オーディオタグ付き。冒頭は [confident] で始める（フック）。締めは [pause 1s][calm] でブランドメッセージ。数字はすべてカタカナ読みで書く。例：[confident] クロームを、一切排除した。[pause 0.8s][calm] 残ったのは、直線だけ。[pause 0.6s] すべてが、意志を持っている。[pause 1s][calm] ハイトップコーポレーション。[pause 0.5s] マイ パッション イズ ワン コード。）",
  "seo": {
