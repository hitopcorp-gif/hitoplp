...
以下のJSON形式で出力してください（他のテキスト不要）：
{
  ...
  "reelNarration": "（10秒リール／ストーリーズ用の短いナレーション。ルール：車名から始めない。記事の中で最もインパクトのある一節から入る。「実は…」「一切の…」「残ったのは…」のような、聴いた人が「ん？何の話？」と止まるフックから始める。記事全文の中から最も印象的な一節を抜き出して再構成する。最後の一言に必ず「ハイトップ」を入れる。例：「ハイトップが、選んだ一台。」「ハイトップ。」「ハイトップ コーポレーション。」。全体で50〜70文字（読み上げ約8〜10秒）。ElevenLabs v3オーディオタグ付き。冒頭は [confident] で始める（フック）。最後は [calm] + [pause 0.5s] でハイトップを締めに入れる。数字はすべてカタカナ読みで書く。例：[confident] クロームを、一切排除した。[pause 0.8s][calm] 残ったのは、直線だけ。[pause 1s][calm] ハイトップ。）",
  "seo": {
